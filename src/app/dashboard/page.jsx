      ...
      {!user.username ? (
          ...
          <div
            className={`${
              token === undefined || token === null || token === ""
                ? "hidden"
                : " flex  flex-col  justify-center items-center h-[100vh] w-full"
            }`}
          >
            <Image
              alt=""
            ...
            <div className=" shadow p-5 rounded-lg w-[90%] bg-gray-100 outline-[#000000ae] m-3 flex gap-8 flex-col text-center">
              <p
                ...
                className="  text-blue-800    font-extrabold font-montserrat  text-[30px]"
              >
                {" "}
                LEARN VERSE
              </p>
              <p className=" font-[fantasy] text-center mb-5 px-9 text-blue-800 font-extrabold text-[16px]">
                Embark on a Journey of Discovery and Transformation
              </p>
            </div>
            <Image
              alt=""
              className=" bg-transparent rounded-full justify-center flex items-center "
              src={"/spin.gif"}
              width={50}
              height={50}
            />
        ...
        <div className="py-6 relative flex flex-col gap-3 pb-32">
          <Image
            width={30}
            height={30}
            className="w-[3.3em] absolute top-[5px] rounded-full"
            src="/lk.png"
          />
          <ToastContainer
            className=" mb-8"
            ...
            {user.profile_picture ? (
              <div className="  relative">
                <Image
                  width={176}
                  height={96}
                  className="max-w-[60px] rounded-full h-[60px]  "
          ...
          <p className="px-4  font-montserrat font-bold text-[1.3em]">
          ...
          <div className="flex pt-3 gap-4 justify-between px-4">
            ...
            <button
              ...
              className="w-10 h-10 bg-[#67949E] rounded-lg flex items-center cursor-pointer justify-center"
            >
              <Image width={30} height={30} src="/filter.svg" alt="" />
            </button>
          </div>
          <h2 className=" text-lg font-extrabold text-gray-500  my-4 px-4 ">
            Course Categories
          </h2>
          <div className="flex items-start justify-between px-4">
            {filteredCourses.length > 0 ? (
              ...
              <p className=" text-red-600  w-full">
                No course of this Category
              </p>
            )}
          </div>
          <h2 className=" font-[900] text-lg text-gray-500  my-4 px-4">
            Popular Topics
          </h2>
            ...
            {popularCoursses
              ...
              .map((course) => (
                <>
                  <Link
                    key={course.id}
                    onClick={() => setCourseID(course.id + 5)}
                    href={"/courses/" + (course.id + 5)}
                  >
                    <PopularCard
                      img={course}
                      course={course.title}
